          ...
          <div className="px-8 py-8">
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-4">
                ...
                />
                <div>
                  <h1 className="text-3xl font-bold text-slate-900">David Nummi</h1>
            ...
            {/* Contact Info */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-8 pt-8 border-t border-slate-200">
              <div>
                <p className="text-sm text-slate-600 font-medium mb-2">Email Address:</p>
                <p className="text-slate-900 text-sm">davidnumminer@telework.us</p>
              </div>
              <div>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                {interestedProperties.map((property) => (
                  <div key={property.id} className="group relative overflow-hidden rounded-xl cursor-pointer">
                    <img
                      src={property.image}
                      alt={property.title}
                      className="w-full h-40 object-cover group-hover:scale-110 transition-transform duration-300"
                    />
                    <div className="absolute top-3 left-3 bg-orange-500 text-white w-8 h-8 rounded-lg flex items-center justify-center font-bold text-sm">
                      {property.badge}
                    </div>
              ...
              <div className="mt-6 grid grid-cols-3 gap-4">
                {interestedProperties.map((property, idx) => (
                  <div key={idx} className="p-4 bg-slate-50 rounded-lg">
                    <p className="text-sm font-semibold text-slate-900 mb-2">{property.title}</p>
                    <p className="text-xs text-slate-600 mb-3">{property.address}</p>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <select className="text-sm border border-slate-300 rounded-lg px-3 py-1 text-slate-700">
