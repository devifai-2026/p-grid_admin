        ...
        {agents.map((agent) => (
          ...
          >
            ...
            <div className="h-32 bg-gradient-to-r from-slate-100 via-slate-50 to-slate-100 relative overflow-hidden">
              ...
              {/* Decorative leaves */}
              <div className="absolute -top-8 left-2 text-green-200 opacity-30 text-3xl">
                🍃
              </div>
              <div className="absolute top-4 right-12 text-yellow-200 opacity-20 text-2xl">
                🌿
              </div>
            </div>
            ...
            <div className="px-6 pb-6">
              ...
              <div className="flex justify-center -mt-16 mb-4">
                <div className="relative">
                  ...
                  />
                  <div
                    className={`absolute bottom-0 right-0 w-8 h-8 ${agent.statusColor} rounded-full border-3 border-white`}
                  ></div>
                </div>
              </div>
              ...
              <div className="text-center mb-4">
                ...
                <span
                  className={`inline-block px-3 py-1 rounded-full text-xs font-semibold text-white ${agent.statusColor}`}
                >
                  {agent.status}
                </span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-6 pb-6 border-b border-slate-100">
                ...
                <div className="text-center">
                  <p className="text-xl font-bold text-[#EE2529]">
                    {agent.investProperty}
                  </p>
                  <p className="text-xs text-slate-600 font-medium">
                    Invest On
                  </p>
