      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.description}>
            Excellent {property.propertyType} property located at{" "}
            {property.city}, {property.state}. Offering a great investment
            opportunity with an expected ROI of{" "}
            {property.grossRentalYield || "N/A"}%. This property features{" "}
            {property.carpetArea} {property.carpetAreaUnit} of premium space in
            a{property.buildingGrade || "Grade A"} building. The property is
            well-maintained with high-quality infrastructure and modern
            amenities.
          </Text>
        </View>
            ...
            <View style={styles.amenitiesGrid}>
              ...
              <View style={styles.amenityItem}>
                ...
                <Text style={styles.amenityText}>
                  {property.powerBackup} Power Backup
                </Text>
              </View>
              <View style={styles.amenityItem}>
                <View style={styles.amenityDot} />
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            Generated by Pre-Lease Grid | {new Date().toLocaleDateString()}
          </Text>
